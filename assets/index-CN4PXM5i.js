...
`)}var tl={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function nl(e,t){let n=tl[t];return n===void 0?(V(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var rl=new K;function il(){return J.getLuminanceCoefficients(rl),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${rl.x.toFixed(4)}, ${rl.y.toFixed(4)}, ${rl.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=qc(i,i.VERTEX_SHADER,y),S=qc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=$c(i,x,`vertex`),n=$c(i,S,`fragment`);H(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`;function Ou(e){return new pa({uniforms:{uTerminal:{value:e},uTime:{value:0},uPower:{value:0}},vertexShader:Eu,fragmentShader:Du,toneMapped:!1})}function ku(e,t,n){return Math.min(n,Math.max(t,e))}function Au(e,t,n){return e+(t-e)*n}function ju(e){return e<.5?4*e*e*e:1-(-2*e+2)**3/2}var Mu={type:`change`},Nu={type:`start`},Pu={type:`end`},Fu=new Vr,Iu=new Pr,Lu=Math.cos(70*Ot.DEG2RAD),Ru=new K,zu=2*Math.PI,Bu={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Vu=1e-6,Hu=class extends Yo{constructor(n,r=null){super(n,r),this.state=Bu.NONE,this.target=new K,this.cursor=new K,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:`ArrowLeft`,UP:`ArrowUp`,RIGHT:`ArrowRight`,BOTTOM:`ArrowDown`},this.mouseButtons={LEFT:e.ROTATE,MIDDLE:e.DOLLY,RIGHT:e.PAN},this.touches={ONE:t.ROTATE,TWO:t.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle=`auto`,this._domElementKeyEvents=null,this._lastPosition=new K,this._lastQuaternion=new kt,this._lastTargetPosition=new K,this._quat=new kt().setFromUnitVectors(n.up,new K(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new Jo,this._sphericalDelta=new Jo,this._scale=1,this._panOffset=new K,this._rotateStart=new G,this._rotateEnd=new G,this._rotateDelta=new G,this._panStart=new G,this._panEnd=new G,this._panDelta=new G,this._dollyStart=new G,this._dollyEnd=new G,this._dollyDelta=new G,this._dollyDirection=new K,this._mouse=new G,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=Wu.bind(this),this._onPointerDown=Uu.bind(this),this._onPointerUp=Gu.bind(this),this._onContextMenu=Qu.bind(this),this._onMouseWheel=Ju.bind(this),this._onKeyDown=Yu.bind(this),this._onTouchStart=Xu.bind(this),this._onTouchMove=Zu.bind(this),this._onMouseDown=Ku.bind(this),this._onMouseMove=qu.bind(this),this._interceptControlDown=$u.bind(this),this._interceptControlUp=ed.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e===`grab`?this.domElement.style.cursor=`grab`:this.domElement.style.cursor=`auto`}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener(`pointerdown`,this._onPointerDown),this.domElement.addEventListener(`pointercancel`,this._onPointerUp),this.domElement.addEventListener(`contextmenu`,this._onContextMenu),this.domElement.addEventListener(`wheel`,this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener(`keydown`,this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction=`none`}disconnect(){this.state=Bu.NONE,this.domElement.removeEventListener(`pointerdown`,this._onPointerDown),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.domElement.removeEventListener(`pointercancel`,this._onPointerUp),this.domElement.removeEventListener(`wheel`,this._onMouseWheel),this.domElement.removeEventListener(`contextmenu`,this._onContextMenu),this.stopListenToKeyEvents();let e=this.domElement.getRootNode();e.removeEventListener(`keydown`,this._interceptControlDown,{capture:!0}),e.removeEventListener(`keyup`,this._interceptControlUp,{capture:!0}),this._controlActive=!1,this._pointers.length=0,this._pointerPositions={},this.domElement.style.touchAction=``,this.domElement.style.cursor=`auto`}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Mu),this.update(),this.state=Bu.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){let t=this.object.position;Ru.copy(t).sub(this.target),Ru.applyQuaternion(this._quat),this._spherical.setFromVector3(Ru),this.autoRotate&&this.state===Bu.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=zu:n>Math.PI&&(n-=zu),r<-Math.PI?r+=zu:r>Math.PI&&(r-=zu),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let i=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let e=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),i=e!=this._spherical.radius}if(Ru.setFromSpherical(this._spherical),Ru.applyQuaternion(this._quatInverse),t.copy(this.target).add(Ru),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let e=null;if(this.object.isPerspectiveCamera){let t=Ru.length();e=this._clampDistance(t*this._scale);let n=t-e;this.object.position.addScaledVector(this._dollyDirection,n),this.object.updateMatrixWorld(),i=!!n}else if(this.object.isOrthographicCamera){let t=new K(this._mouse.x,this._mouse.y,0);t.unproject(this.object);let n=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),i=n!==this.object.zoom;let r=new K(this._mouse.x,this._mouse.y,0);r.unproject(this.object),this.object.position.sub(r).add(t),this.object.updateMatrixWorld(),e=Ru.length()}else console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled.`),this.zoomToCursor=!1;e!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position):(Fu.origin.copy(this.object.position),Fu.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Fu.direction))<Lu?this.object.lookAt(this.target):(Iu.setFromNormalAndCoplanarPoint(this.object.up,this.target),Fu.intersectPlane(Iu,this.target))))}else if(this.object.isOrthographicCamera){let e=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),e!==this.object.zoom&&(this.object.updateProjectionMatrix(),i=!0)}return this._scale=1,this._performCursorZoom=!1,i||this._lastPosition.distanceToSquared(this.object.position)>Vu||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Vu||this._lastTargetPosition.distanceToSquared(this.target)>Vu?(this.dispatchEvent(Mu),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e===null?zu/60/60*this.autoRotateSpeed:zu/60*this.autoRotateSpeed*e}_getZoomScale(e){let t=Math.abs(e*.01);return .95**(this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){Ru.setFromMatrixColumn(t,0),Ru.multiplyScalar(-e),this._panOffset.add(Ru)}_panUp(e,t){this.screenSpacePanning===!0?Ru.setFromMatrixColumn(t,1):(Ru.setFromMatrixColumn(t,0),Ru.crossVectors(this.object.up,Ru)),Ru.multiplyScalar(e),this._panOffset.add(Ru)}_pan(e,t){let n=this.domElement;if(this.object.isPerspectiveCamera){let r=this.object.position;Ru.copy(r).sub(this.target);let i=Ru.length();i*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*i/n.clientHeight,this.object.matrix),this._panUp(2*t*i/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.`),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let n=this.domElement.getBoundingClientRect(),r=e-n.left,i=t-n.top,a=n.width,o=n.height;this._mouse.x=r/a*2-1,this._mouse.y=-(i/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(zu*this._rotateDelta.x/t.clientHeight),this._rotateUp(zu*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(zu*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-zu*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(zu*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-zu*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyStart.set(0,i)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateEnd.set(n,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(zu*this._rotateDelta.x/t.clientHeight),this._rotateUp(zu*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,i),this._dollyDelta.set(0,(this._dollyEnd.y/this._dollyStart.y)**+this.zoomSpeed),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new G,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){let t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){let t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}};function Uu(e){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(e.pointerId),this.domElement.ownerDocument.addEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.addEventListener(`pointerup`,this._onPointerUp)),!this._isTrackingPointer(e)&&(this._addPointer(e),e.pointerType===`touch`?this._onTouchStart(e):this._onMouseDown(e),this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grabbing`)))}function Wu(e){this.enabled!==!1&&(e.pointerType===`touch`?this._onTouchMove(e):this._onMouseMove(e))}function Gu(e){switch(this._removePointer(e),this._pointers.length){case 0:this.domElement.releasePointerCapture(e.pointerId),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.dispatchEvent(Pu),this.state=Bu.NONE,this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grab`);break;case 1:let t=this._pointers[0],n=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:n.x,pageY:n.y})}}function Ku(t){let n;switch(t.button){case 0:n=this.mouseButtons.LEFT;break;case 1:n=this.mouseButtons.MIDDLE;break;case 2:n=this.mouseButtons.RIGHT;break;default:n=-1}switch(n){case e.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(t),this.state=Bu.DOLLY;break;case e.ROTATE:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=Bu.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=Bu.ROTATE}break;case e.PAN:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=Bu.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=Bu.PAN}break;default:this.state=Bu.NONE}this.state!==Bu.NONE&&this.dispatchEvent(Nu)}function qu(e){switch(this.state){case Bu.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(e);break;case Bu.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(e);break;case Bu.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(e)}}function Ju(e){this.enabled!==!1&&this.enableZoom!==!1&&this.state===Bu.NONE&&(e.preventDefault(),this.dispatchEvent(Nu),this._handleMouseWheel(this._customWheelEvent(e)),this.dispatchEvent(Pu))}function Yu(e){this.enabled!==!1&&this._handleKeyDown(e)}function Xu(e){switch(this._trackPointer(e),this._pointers.length){case 1:switch(this.touches.ONE){case t.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(e),this.state=Bu.TOUCH_ROTATE;break;case t.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(e),this.state=Bu.TOUCH_PAN;break;default:this.state=Bu.NONE}break;case 2:switch(this.touches.TWO){case t.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(e),this.state=Bu.TOUCH_DOLLY_PAN;break;case t.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(e),this.state=Bu.TOUCH_DOLLY_ROTATE;break;default:this.state=Bu.NONE}break;default:this.state=Bu.NONE}this.state!==Bu.NONE&&this.dispatchEvent(Nu)}function Zu(e){switch(this._trackPointer(e),this.state){case Bu.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(e),this.update();break;case Bu.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(e),this.update();break;case Bu.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(e),this.update();break;case Bu.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(e),this.update();break;default:this.state=Bu.NONE}}function Qu(e){this.enabled!==!1&&e.preventDefault()}function $u(e){e.key===`Control`&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function ed(e){e.key===`Control`&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}var td=Ot.degToRad(30),nd=Ot.degToRad(10),rd=Ot.degToRad(1),id=1,ad=1,od={azimuth:`left`,polar:`up`},sd=1.15,cd=class{constructor(){this.closeFov=38,this.roomFov=36,this.camera=new mo(this.closeFov,2/3,.04,80),this.cameraFrom=new K,this.cameraTo=new K,this.cameraRoom=new K,this.defaultViewPosition=new K,this.lookClose=new K,this.lookRoom=new K,this.lookAt=new K,this.screenNormal=new K(0,0,1),this.screenUp=new K(0,1,0),this.frameHalfWidth=.14,this.frameHalfHeight=.09,this.roomBox=new Jn,this.controls=null,this.roomRoot=null,this.laptopScreen=null,this._size=new K,this._holdPosition=new K,this._holdLook=new K,this.poseFrom=new K,this.poseTo=new K,this.poseLookFrom=new K,this.poseLookTo=new K,this.poseTime=0,this.poseDuration=sd,this.poseActive=!1,this._center=new K,this._viewer=new K}aim(e,t){this.laptopScreen=e,this.roomRoot=t;let n=new K,r=new kt;e.updateWorldMatrix(!0,!1),e.getWorldPosition(n),e.getWorldQuaternion(r);let i=e.geometry;i.computeBoundingBox();let a=i.boundingBox.getSize(this._size),o=new K;e.getWorldScale(o),this.frameHalfWidth=a.x*o.x/2,this.frameHalfHeight=a.y*o.y/2,this.screenUp.set(0,1,0).applyQuaternion(r).normalize();let s=new K(0,0,1).applyQuaternion(r).normalize(),c=s.clone().negate();this.roomBox.setFromObject(t);let l=t.getObjectByName(`Chair`);l?l.getWorldPosition(this._viewer):this.roomBox.getCenter(this._viewer),this._viewer.sub(n),this._viewer.y=0,this._viewer.lengthSq()<1e-4?this._viewer.set(0,0,-1):this._viewer.normalize();let u=i.boundingBox.getCenter(new K);e.localToWorld(u),this.screenNormal.copy(s.dot(this._viewer)>=c.dot(this._viewer)?s:c),this.screenNormal.negate(),this.lookClose.copy(u),this.placeCloseCamera(),this.frameRoomCamera(),this.lookAt.copy(this.lookClose),this.camera.position.copy(this.cameraFrom),this.camera.lookAt(this.lookAt)}placeCloseCamera(){let e=Ot.degToRad(this.closeFov),t=Math.max(this.camera.aspect,.01),n=Math.max(this.frameHalfWidth*1.22/(Math.tan(e/2)*t),this.frameHalfHeight*1.22/Math.tan(e/2)),r=n*.82;this.cameraTo.copy(this.lookClose).addScaledVector(this.screenNormal,r).addScaledVector(this.screenUp,this.frameHalfHeight*.22).add(new K(0,.3,-.2)),this.cameraFrom.copy(this.lookClose).addScaledVector(this.screenNormal,n).addScaledVector(this.screenUp,this.frameHalfHeight*.28).add(new K(0,.1,0)),this.nudgeAwayFromChair(this.cameraFrom)}nudgeAwayFromChair(e){let t=this.roomRoot?.getObjectByName(`Chair`);if(!t)return;let n=new Jn().setFromObject(t);n.expandByScalar(.1);let r=n.getCenter(new K),i=new Vr(e,this.lookClose.clone().sub(e).normalize());if(!n.containsPoint(e)&&!i.intersectsBox(n))return;let a=e.clone().sub(r);a.y=0,a.lengthSq()<1e-4&&a.crossVectors(this.screenNormal,new K(0,1,0)),a.normalize(),e.addScaledVector(a,.32),e.y+=.2;let o=new Vr(e,this.lookClose.clone().sub(e).normalize());(n.containsPoint(e)||o.intersectsBox(n))&&(e.addScaledVector(a,.2),e.y+=.16)}frameRoomCamera(){if(this.roomBox.isEmpty())return;let e=this.roomBox.getSize(this._size),t=this.roomBox.getCenter(this._center),n=1.08,r=Ot.degToRad(this.roomFov),i=Math.max(this.camera.aspect,.01),a=Math.max(e.y*.5*n/Math.tan(r/2),e.x*.5*n/(Math.tan(r/2)*i));this.lookRoom.copy(t),this.lookRoom.y=t.y*.78;let o=this.roomRoot?.getObjectByName(`Flower`);if(o){let e=new Jn().setFromObject(o).getCenter(this.lookRoom);this.lookRoom.set(e.x-.2,e.y,e.z-.2)}this.cameraRoom.copy(t).addScaledVector(this.screenNormal,a*.42),this.cameraRoom.y=t.y+e.y*.1;let s=.22;this.cameraRoom.x=ku(this.cameraRoom.x,this.roomBox.min.x+s,this.roomBox.max.x-s),this.cameraRoom.y=ku(this.cameraRoom.y,this.roomBox.min.y+.7,this.roomBox.max.y-s),this.cameraRoom.z=ku(this.cameraRoom.z,this.roomBox.min.z+s,this.roomBox.max.z-s)}setupControls(e){this.controls=new Hu(this.camera,e),this.controls.enabled=!1,this.controls.enableDamping=!0,this.controls.dampingFactor=.08,this.controls.enablePan=!1,this.controls.rotateSpeed=.72,this.controls.zoomSpeed=.9,this.controls.minPolarAngle=.18,this.controls.maxPolarAngle=Math.PI*.49,this.captureDefaultView()}applyStoryCamera(e,t){t>0?(this.camera.position.lerpVectors(this.cameraTo,this.defaultViewPosition,t),this.lookAt.lerpVectors(this.lookClose,this.lookRoom,t),this.camera.fov=Au(this.closeFov,this.roomFov,t)):(this.camera.position.lerpVectors(this.cameraFrom,this.cameraTo,e),this.lookAt.copy(this.lookClose),this.camera.fov=this.closeFov),this.camera.lookAt(this.lookAt),this.camera.updateProjectionMatrix()}captureDefaultView(){this._holdPosition.copy(this.camera.position),this._holdLook.copy(this.lookAt);let e=this.camera.fov;this.controls.target.copy(this.lookRoom),this.camera.position.copy(this.cameraRoom),this.camera.fov=this.roomFov,this.camera.lookAt(this.controls.target),this.limitOrbitAngles(),this.placeAtDefaultView(),this.defaultViewPosition.copy(this.camera.position),this.camera.position.copy(this._holdPosition),this.lookAt.copy(this._holdLook),this.camera.fov=e,this.camera.lookAt(this.lookAt),this.camera.updateProjectionMatrix()}enterViewMode({useDefaultPose:e=!1}={}){this._holdPosition.copy(this.camera.position),this._holdLook.copy(this.lookAt),this.controls.target.copy(this.lookRoom),this.camera.fov=this.roomFov,this.camera.position.copy(this.cameraRoom),this.limitOrbitAngles();let t=e?this.defaultViewPosition:this.cameraRoom;if(this.camera.position.copy(this._holdPosition),this.lookAt.copy(this._holdLook),!e||this._holdPosition.distanceTo(t)<.002){this.poseActive=!1,this.camera.position.copy(t),this.lookAt.copy(this.lookRoom),this.camera.lookAt(this.lookAt),this.camera.updateProjectionMatrix(),this.controls.enabled=!0,this.controls.update();return}this.controls.enabled=!1,this.camera.lookAt(this.lookAt),this.camera.updateProjectionMatrix(),this.moveTo(t,this.lookRoom)}moveTo(e,t,n=sd){this.poseFrom.copy(this.camera.position),this.poseLookFrom.copy(this.lookAt),this.poseTo.copy(e),this.poseLookTo.copy(t),this.poseTime=0,this.poseDuration=n;let r=this.poseFrom.distanceTo(this.poseTo)<.002&&this.poseLookFrom.distanceTo(this.poseLookTo)<.002;this.poseActive=!r,r&&(this.camera.position.copy(this.poseTo),this.lookAt.copy(this.poseLookTo),this.camera.lookAt(this.lookAt),this.camera.updateProjectionMatrix())}updatePose(e){if(!this.poseActive)return!1;this.poseTime+=e;let t=ju(ku(this.poseTime/this.poseDuration,0,1));return this.camera.position.lerpVectors(this.poseFrom,this.poseTo,t),this.lookAt.lerpVectors(this.poseLookFrom,this.poseLookTo,t),this.camera.lookAt(this.lookAt),this.camera.updateProjectionMatrix(),t>=1&&(this.poseActive=!1),!0}placeAtDefaultView(){let e=this.controls.target,t=Math.max(this.camera.position.distanceTo(e),.001),n=od.azimuth===`left`?this.controls.minAzimuthAngle:this.controls.maxAzimuthAngle,r=od.polar===`up`?this.controls.minPolarAngle:this.controls.maxPolarAngle;this._viewer.setFromSphericalCoords(t,r,n),this.camera.position.copy(e).add(this._viewer),this.camera.lookAt(e),this.camera.updateProjectionMatrix()}limitOrbitAngles(){let e=this._viewer.copy(this.camera.position).sub(this.controls.target),t=Math.max(e.length(),.001),n=Math.atan2(e.x,e.z);this.controls.minAzimuthAngle=n-td,this.controls.maxAzimuthAngle=n+nd;let r=Math.acos(Ot.clamp(e.y/t,-1,1));this.controls.minPolarAngle=Math.max(0,r-rd),this.controls.maxPolarAngle=Math.min(0,r-rd),this.controls.minDistance=t*id,this.controls.maxDistance=t*ad}enterInteractiveMode(e,t){if(this.controls.enabled=!1,t>=1){this.camera.fov=this.roomFov,this.moveTo(this.defaultViewPosition,this.lookRoom);return}this.poseActive=!1,this.applyStoryCamera(e,t)}setControlsEnabled(e){this.controls&&(this.controls.enabled=e)}resize(e,t,n,r,i){if(this.camera.aspect=e/Math.max(t,1),this.laptopScreen&&(this.placeCloseCamera(),this.frameRoomCamera()),n===`interactive`){this.poseActive||this.applyStoryCamera(r,i);return}this.camera.updateProjectionMatrix(),this.controls?.update()}focusPoint(){return this.controls?.enabled?this.controls.target:this.lookAt}dispose(){this.controls?.dispose(),this.controls=null}},ld={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`},ud=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},dd=new yo(-1,1,1,-1,0,1),fd=new class extends Dr{constructor(){super(),this.setAttribute(`position`,new hr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new hr([0,2,0,0,2,0],2))}},pd=class{constructor(e){this._mesh=new ei(fd,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,dd)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},md=class extends ud{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof pa?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=ua.clone(e.uniforms),this.material=new pa({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new pd(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},hd=class extends ud{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},gd=class extends ud{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},_d=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new G);this._width=n.width,this._height=n.height,t=new Jt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:y}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new md(ld),this.copyPass.material.blending=0,this.timer=new ko}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}hd!==void 0&&(r instanceof hd?n=!0:r instanceof gd&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new G);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},vd={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		void main() {
			...
			// color space
				...
				}`,blending:2,depthTest:!1,depthWrite:!1,transparent:!0})}};bd.BlurDirectionX=new G(1,0),bd.BlurDirectionY=new G(0,1);var xd=class extends ud{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new X}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Sd={books:`JavaScript for Beginners: 847 pages. You read 3.`,bed:`You probably won't get much sleep anymore.`,laptop:`Maybe I should learn programming.`,mug:`Coffee. Your first dependency.`},Cd={Books:`books`,Bed:`bed`,Mac:`laptop`,Coffee:`mug`};function wd(e){return!!(e.target.closest?.(`#mode-toggle`)||e.target.closest?.(`#inspect-modal`))}var Td=class{constructor({threeScene:e,camera:t,renderer:n,canvas:r,getPlayMode:i,cameraRig:a}){this.threeScene=e,this.camera=t,this.renderer=n,this.canvas=r,this.getPlayMode=i,this.cameraRig=a,this.modal=document.querySelector(`#inspect-modal`),this.text=document.querySelector(`#inspect-modal-text`),this.closeButton=document.querySelector(`#inspect-modal-close`),this.open=!1,this.hoveredId=null,this.pointerNdc=new G,this.raycaster=new Wo,this.targets=[],this.groups={books:[],bed:[],laptop:[],mug:[]},this.pointerDown=null,this.composer=null,this.outlinePass=null}setup(e,t){this.targets=[],this.groups={books:[],bed:[],laptop:[],mug:[]},e.traverse(e=>{let t=e.userData.inspectId;e.isMesh&&t&&(this.groups[t].push(e),this.targets.push(e))}),t&&(t.userData.inspectId=`laptop`,this.groups.laptop.push(t),this.targets.push(t)),this.setupComposer()}setupComposer(){let e=new G;this.renderer.getSize(e);let t=new Jt(1,1,{type:y,samples:Math.min(4,this.renderer.capabilities.maxSamples)});this.composer=new _d(this.renderer,t),this.composer.setPixelRatio(this.renderer.getPixelRatio()),this.composer.setSize(e.x,e.y),this.composer.addPass(new xd(this.threeScene,this.camera)),this.outlinePass=new bd(e,this.threeScene,this.camera),this.outlinePass.edgeStrength=8.5,this.outlinePass.edgeGlow=.75,this.outlinePass.edgeThickness=3.2,this.outlinePass.pulsePeriod=0,this.outlinePass.visibleEdgeColor.set(11927520),this.outlinePass.hiddenEdgeColor.set(4165480),this.outlinePass.selectedObjects=[],this.composer.addPass(this.outlinePass),this.composer.addPass(new yd)}bind(){this.onMove=e=>{if(this.open||wd(e))return;let t=this.hitId(e);this.setHovered(this.canInspect(t)?t:null)},this.onDown=e=>{if(wd(e)){this.pointerDown=null;return}let t=this.hitId(e);this.pointerDown={x:e.clientX,y:e.clientY,inspectId:this.canInspect(t)?t:null}},this.onUp=e=>{let t=this.pointerDown;if(this.pointerDown=null,!t?.inspectId||this.open||wd(e))return;let n=e.clientX-t.x,r=e.clientY-t.y;if(n*n+r*r>64)return;let i=this.hitId(e);i===t.inspectId&&this.openModal(i)},this.onLeave=()=>{this.open||this.setHovered(null)},this.onClose=e=>{e.stopPropagation(),this.closeModal()},this.onBackdrop=e=>{e.target.closest(`.inspect-modal-dialog`)||this.closeModal()},this.onKey=e=>e.key!==`Escape`||!this.open?!1:(e.preventDefault(),this.closeModal(),!0),this.canvas.addEventListener(`pointermove`,this.onMove),this.canvas.addEventListener(`pointerdown`,this.onDown),this.canvas.addEventListener(`pointerleave`,this.onLeave),window.addEventListener(`pointerup`,this.onUp),this.closeButton?.addEventListener(`click`,this.onClose),document.addEventListener(`pointerdown`,this.onBackdrop)}unbind(){this.canvas.removeEventListener(`pointermove`,this.onMove),this.canvas.removeEventListener(`pointerdown`,this.onDown),this.canvas.removeEventListener(`pointerleave`,this.onLeave),window.removeEventListener(`pointerup`,this.onUp),this.closeButton?.removeEventListener(`click`,this.onClose),document.removeEventListener(`pointerdown`,this.onBackdrop),this.canvas.style.cursor=``}setPointerFromEvent(e){let t=this.canvas.getBoundingClientRect(),n=Math.max(t.width,1),r=Math.max(t.height,1);this.pointerNdc.x=(e.clientX-t.left)/n*2-1,this.pointerNdc.y=-((e.clientY-t.top)/r)*2+1}hitId(e){return this.targets.length?(this.setPointerFromEvent(e),this.raycaster.setFromCamera(this.pointerNdc,this.camera),this.raycaster.intersectObjects(this.targets,!1)[0]?.object.userData.inspectId??null):null}canInspect(e){return!(!e||this.open||this.getPlayMode()===`interactive`&&e===`laptop`)}setHovered(e){if(this.hoveredId===e){this.canvas.style.cursor=e?`pointer`:``;return}this.hoveredId=e,this.canvas.style.cursor=e?`pointer`:``,this.outlinePass&&(this.outlinePass.selectedObjects=e?this.groups[e]:[])}openModal(e){this.canInspect(e)&&this.modal&&this.text&&(this.open=!0,this.text.textContent=Sd[e],this.modal.hidden=!1,this.setHovered(e),this.getPlayMode()===`view`&&this.cameraRig.setControlsEnabled(!1),this.closeButton?.focus())}closeModal(){this.open&&(this.open=!1,this.modal&&(this.modal.hidden=!0),this.getPlayMode()===`view`&&this.cameraRig.setControlsEnabled(!0))}render(){return this.composer?(this.composer.render(),!0):!1}resize(e,t){this.composer&&(this.composer.setPixelRatio(this.renderer.getPixelRatio()),this.composer.setSize(e,t))}dispose(){this.unbind(),this.composer?.dispose(),this.composer=null,this.outlinePass=null}};function Ed({laptopScreen:e,material:t,screenNormal:n,previous:r}){r&&(r.removeFromParent(),r.geometry.dispose());let i=e.geometry;i.computeBoundingBox();let a=i.boundingBox,o=new ia(a.max.x-a.min.x,a.max.y-a.min.y),s=e.matrixWorld.clone().invert(),c=n.clone().transformDirection(s).z>=0?1:-1;if(c<0){let e=o.attributes.uv;for(let t=0;t<e.count;t+=1)e.setX(t,1-e.getX(t));e.needsUpdate=!0}let l=new ei(o,t);return l.position.set((a.min.x+a.max.x)/2,(a.min.y+a.max.y)/2,(a.min.z+a.max.z)/2+c*.0015),c<0&&(l.rotation.y=Math.PI),e.add(l),l}var Dd=new WeakMap,Od=new URL(`/3d-room/assets/draco_decoder-C32yEggz.wasm`,``+import.meta.url).toString(),kd=new URL(`/3d-room/assets/draco_wasm_wrapper-DxJM36Ib.js`,``+import.meta.url).toString(),Ad=new URL(`/3d-room/assets/draco_decoder-fzg4nYZr.js`,``+import.meta.url).toString();new URL(`/3d-room/assets/draco_wasm_wrapper-fZCQGLGb.js`,``+import.meta.url).toString(),new URL(`/3d-room/assets/draco_decoder-Z1_iN-Ht.wasm`,``+import.meta.url).toString();var jd=class extends Ja{constructor(e){super(e),this.decoderPaths={js:kd,wasm:Od,dep_js:Ad},this.decoderConfig={},this.decoderBinary=null,this.decoderPending=null,this.workerLimit=4,this.workerPool=[],this.workerNextTaskID=1,this.workerSourceURL=``,this.defaultAttributeIDs={position:`POSITION`,normal:`NORMAL`,color:`COLOR`,uv:`TEX_COORD`},this.defaultAttributeTypes={position:`Float32Array`,normal:`Float32Array`,color:`Float32Array`,uv:`Float32Array`}}setDecoderPath(e){let{decoderPaths:t}=this;return typeof e==`object`?(t.js=e.js,t.wasm=e.wasm,t.dep_js=null):(t.js=So.resolveURL(`draco_wasm_wrapper.js`,e),t.wasm=So.resolveURL(`draco_decoder.wasm`,e),t.dep_js=So.resolveURL(`draco_decoder.js`,e)),this}setDecoderConfig(e){return console.warn(`THREE.DRACOLoader: setDecoderConfig to has been deprecated and will be removed in r194.`),this.decoderConfig=e,this}setWorkerLimit(e){return this.workerLimit=e,this}load(e,t,n,r){let i=new Za(this.manager);i.setPath(this.path),i.setResponseType(`arraybuffer`),i.setRequestHeader(this.requestHeader),i.setWithCredentials(this.withCredentials),i.load(e,e=>{this.parse(e,t,r)},n,r)}parse(e,t,n=()=>{}){this.decodeDracoFile(e,t,null,null,Be,n).catch(n)}decodeDracoFile(e,t,n,r,i=Ve,a=()=>{}){let o={attributeIDs:n||this.defaultAttributeIDs,attributeTypes:r||this.defaultAttributeTypes,useUniqueIDs:!!n,vertexColorSpace:i};return this.decodeGeometry(e,o).then(t).catch(a)}decodeGeometry(e,t){let n=JSON.stringify(t);if(Dd.has(e)){let t=Dd.get(e);if(t.key===n)return t.promise;if(e.byteLength===0)throw Error(`THREE.DRACOLoader: Unable to re-decode a buffer with different settings. Buffer has already been transferred.`)}let r,i=this.workerNextTaskID++,a=e.byteLength,o=this._getWorker(i,a).then(n=>(r=n,new Promise((n,a)=>{r._callbacks[i]={resolve:n,reject:a},r.postMessage({type:`decode`,id:i,taskConfig:t,buffer:e},[e])}))).then(e=>this._createGeometry(e.geometry));return o.catch(()=>!0).then(()=>{r&&i&&this._releaseTask(r,i)}),Dd.set(e,{key:n,promise:o}),o}_createGeometry(e){let t=new Dr;e.index&&t.setIndex(new fr(e.index.array,1));for(let n=0;n<e.attributes.length;n++){let{name:r,array:i,itemSize:a,stride:o,vertexColorSpace:s}=e.attributes[n],c;c=a===o?new fr(i,a):new Ar(new Or(i,o),a,0),r===`color`&&(this._assignVertexColorSpace(c,s),c.normalized=!(i instanceof Float32Array)),t.setAttribute(r,c)}return t}_assignVertexColorSpace(e,t){if(t!==`srgb`)return;let n=new X;for(let t=0,r=e.count;t<r;t++)n.fromBufferAttribute(e,t),J.colorSpaceToWorking(n,Be),e.setXYZ(t,n.r,n.g,n.b)}_loadLibrary(e,t){let n=new Za(this.manager);return n.setResponseType(t),n.setWithCredentials(this.withCredentials),new Promise((t,r)=>{n.load(e,t,void 0,r)})}preload(){return this._initDecoder(),this}_initDecoder(){if(this.decoderPending)return this.decoderPending;let e=typeof WebAssembly!=`object`||this.decoderConfig.type===`js`,t=[],{decoderPaths:n}=this;if(e){if(n.dep_js===null)throw Error(`THREE.DRACOLoader: WebAssembly is required when using a custom decoder paths.`);t.push(this._loadLibrary(n.dep_js,`text`))}else t.push(this._loadLibrary(n.js,`text`)),t.push(this._loadLibrary(n.wasm,`arraybuffer`));return this.decoderPending=Promise.all(t).then(t=>{let n=t[0];e||(this.decoderConfig.wasmBinary=t[1]);let r=Md.toString(),i=[`/* draco decoder */`,n,``,`/* worker */`,r.substring(r.indexOf(`{`)+1,r.lastIndexOf(`}`))].join(`
`);this.workerSourceURL=URL.createObjectURL(new Blob([i]))}),this.decoderPending}_getWorker(e,t){return this._initDecoder().then(()=>{if(this.workerPool.length<this.workerLimit){let e=new Worker(this.workerSourceURL);e._callbacks={},e._taskCosts={},e._taskLoad=0,e.postMessage({type:`init`,decoderConfig:this.decoderConfig}),e.onmessage=function(t){let n=t.data;switch(n.type){case`decode`:e._callbacks[n.id].resolve(n);break;case`error`:e._callbacks[n.id].reject(n);break;default:console.error(`THREE.DRACOLoader: Unexpected message, "`+n.type+`"`)}},this.workerPool.push(e)}else this.workerPool.sort(function(e,t){return e._taskLoad>t._taskLoad?-1:1});let n=this.workerPool[this.workerPool.length-1];return n._taskCosts[e]=t,n._taskLoad+=t,n})}_releaseTask(e,t){e._taskLoad-=e._taskCosts[t],delete e._callbacks[t],delete e._taskCosts[t]}debug(){console.log(`Task load: `,this.workerPool.map(e=>e._taskLoad))}dispose(){for(let e=0;e<this.workerPool.length;++e)this.workerPool[e].terminate();return this.workerPool.length=0,this.workerSourceURL!==``&&URL.revokeObjectURL(this.workerSourceURL),this}};function Md(){let e,t;onmessage=function(r){let i=r.data;switch(i.type){case`init`:e=i.decoderConfig,t=new Promise(function(t){e.onModuleLoaded=function(e){t({draco:e})},DracoDecoderModule(e)});break;case`decode`:let r=i.buffer,a=i.taskConfig;t.then(e=>{let t=e.draco,o=new t.Decoder;try{let e=n(t,o,new Int8Array(r),a),s=e.attributes.map(e=>e.array.buffer);e.index&&s.push(e.index.array.buffer),self.postMessage({type:`decode`,id:i.id,geometry:e},s)}catch(e){console.error(e),self.postMessage({type:`error`,id:i.id,error:e.message})}finally{t.destroy(o)}})}};function n(e,t,n,a){let o=a.attributeIDs,s=a.attributeTypes,c,l,u=t.GetEncodedGeometryType(n);if(u===e.TRIANGULAR_MESH)c=new e.Mesh,l=t.DecodeArrayToMesh(n,n.byteLength,c);else if(u===e.POINT_CLOUD)c=new e.PointCloud,l=t.DecodeArrayToPointCloud(n,n.byteLength,c);else throw Error(`THREE.DRACOLoader: Unexpected geometry type.`);if(!l.ok()||c.ptr===0)throw Error(`THREE.DRACOLoader: Decoding failed: `+l.error_msg());let d={index:null,attributes:[]};for(let n in o){let r=self[s[n]],l,u;if(a.useUniqueIDs)u=o[n],l=t.GetAttributeByUniqueId(c,u);else{if(u=t.GetAttributeId(c,e[o[n]]),u===-1)continue;l=t.GetAttribute(c,u)}let f=i(e,t,c,n,r,l);n===`color`&&(f.vertexColorSpace=a.vertexColorSpace),d.attributes.push(f)}return u===e.TRIANGULAR_MESH&&(d.index=r(e,t,c)),e.destroy(c),d}function r(e,t,n){let r=n.num_faces()*3,i=r*4,a=e._malloc(i);t.GetTrianglesUInt32Array(n,i,a);let o=new Uint32Array(e.HEAPF32.buffer,a,r).slice();return e._free(a),{array:o,itemSize:1}}function i(e,t,n,r,i,o){let s=n.num_points(),c=o.num_components(),l=a(e,i),u=c*i.BYTES_PER_ELEMENT,d=Math.ceil(u/4)*4,f=d/i.BYTES_PER_ELEMENT,p=s*u,m=s*d,h=e._malloc(p);t.GetAttributeDataArrayForAllPoints(n,o,l,p,h);let g=new i(e.HEAPF32.buffer,h,p/i.BYTES_PER_ELEMENT),_;if(u===d)_=g.slice();else{_=new i(m/i.BYTES_PER_ELEMENT);let e=0;for(let t=0,n=g.length;t<n;t++){for(let n=0;n<c;n++)_[e+n]=g[t*c+n];e+=f}}return e._free(h),{name:r,count:s,itemSize:c,array:_,stride:f}}function a(e,t){switch(t){case Float32Array:return e.DT_FLOAT32;case Int8Array:return e.DT_INT8;case Int16Array:return e.DT_INT16;case Int32Array:return e.DT_INT32;case Uint8Array:return e.DT_UINT8;case Uint16Array:return e.DT_UINT16;case Uint32Array:return e.DT_UINT32}}}function Nd(e,t){if(t===0)return console.warn(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles.`),e;if(t===2||t===1){let n=e.getIndex();if(n===null){let t=[],r=e.getAttribute(`position`);if(r!==void 0){for(let e=0;e<r.count;e++)t.push(e);e.setIndex(t),n=e.getIndex()}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible.`),e}let r=n.count-2,i=[];if(t===2)for(let e=1;e<=r;e++)i.push(n.getX(0)),i.push(n.getX(e)),i.push(n.getX(e+1));else for(let e=0;e<r;e++)e%2==0?(i.push(n.getX(e)),i.push(n.getX(e+1)),i.push(n.getX(e+2))):(i.push(n.getX(e+2)),i.push(n.getX(e+1)),i.push(n.getX(e)));return i.length/3!==r&&console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.`),e.setIndex(i),e.clearGroups(),e}return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:`,t),e}function Pd(e){let t=new Map,n=new Map,r=e.clone();return Fd(e,r,function(e,r){t.set(r,e),n.set(e,r)}),r.traverse(function(e){if(!e.isSkinnedMesh)return;let r=e,i=t.get(e),a=i.skeleton.bones;r.skeleton=i.skeleton.clone(),r.bindMatrix.copy(i.bindMatrix),r.skeleton.bones=a.map(function(e){return n.get(e)}),r.bind(r.skeleton,r.bindMatrix)}),r}function Fd(e,t,n){n(e,t);for(let r=0;r<e.children.length;r++)Fd(e.children[r],t.children[r],n)}var Id=class extends Ja{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(e){return new Hd(e)}),this.register(function(e){return new Ud(e)}),this.register(function(e){return new Qd(e)}),this.register(function(e){return new $d(e)}),this.register(function(e){return new ef(e)}),this.register(function(e){return new Gd(e)}),this.register(function(e){return new Kd(e)}),this.register(function(e){return new qd(e)}),this.register(function(e){return new Jd(e)}),this.register(function(e){return new Vd(e)}),this.register(function(e){return new Yd(e)}),this.register(function(e){return new Wd(e)}),this.register(function(e){return new Zd(e)}),this.register(function(e){return new Xd(e)}),this.register(function(e){return new zd(e)}),this.register(function(e){return new tf(e,$.EXT_MESHOPT_COMPRESSION)}),this.register(function(e){return new tf(e,$.KHR_MESHOPT_COMPRESSION)}),this.register(function(e){return new nf(e)})}load(e,t,n,r){let i=this,a;if(this.resourcePath!==``)a=this.resourcePath;else if(this.path!==``){let t=So.extractUrlBase(e);a=So.resolveURL(t,this.path)}else a=So.extractUrlBase(e);this.manager.itemStart(e);let o=function(t){r?r(t):console.error(t),i.manager.itemError(e),i.manager.itemEnd(e)},s=new Za(this.manager);s.setPath(this.path),s.setResponseType(`arraybuffer`),s.setRequestHeader(this.requestHeader),s.setWithCredentials(this.withCredentials),s.load(e,function(n){try{i.parse(n,a,function(n){t(n),i.manager.itemEnd(e)},o)}catch(e){o(e)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,r){let i,a={},o={},s=new TextDecoder;if(typeof e==`string`)i=JSON.parse(e);else if(e instanceof ArrayBuffer){if(s.decode(new Uint8Array(e,0,4))===rf){try{a[$.KHR_BINARY_GLTF]=new sf(e)}catch(e){r&&r(e);return}i=JSON.parse(a[$.KHR_BINARY_GLTF].content)}else i=JSON.parse(s.decode(e))}else i=e;if(i.asset===void 0||i.asset.version[0]<2){r&&r(Error(`THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported.`));return}let c=new Nf(i,{path:t||this.resourcePath||``,crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let e=0;e<this.pluginCallbacks.length;e++){let t=this.pluginCallbacks[e](c);t.name||console.error(`THREE.GLTFLoader: Invalid plugin found: missing name`),o[t.name]=t,a[t.name]=!0}if(i.extensionsUsed)for(let e=0;e<i.extensionsUsed.length;++e){let t=i.extensionsUsed[e],n=i.extensionsRequired||[];switch(t){case $.KHR_MATERIALS_UNLIT:a[t]=new Bd;break;case $.KHR_DRACO_MESH_COMPRESSION:a[t]=new cf(i,this.dracoLoader);break;case $.KHR_TEXTURE_TRANSFORM:a[t]=new lf;break;case $.KHR_MESH_QUANTIZATION:a[t]=new uf;break;default:n.indexOf(t)>=0&&o[t]===void 0&&console.warn(`THREE.GLTFLoader: Unknown extension "`+t+`".`)}}c.setExtensions(a),c.setPlugins(o),c.parse(n,r)}parseAsync(e,t){let n=this;return new Promise(function(r,i){n.parse(e,t,r,i)})}};function Ld(){let e={};return{get:function(t){return e[t]},add:function(t,n){e[t]=n},remove:function(t){delete e[t]},removeAll:function(){e={}}}}function Rd(e,t,n){let r=e.json.materials[t];return r.extensions&&r.extensions[n]?r.extensions[n]:null}var $={KHR_BINARY_GLTF:`KHR_binary_glTF`,KHR_DRACO_MESH_COMPRESSION:`KHR_draco_mesh_compression`,KHR_LIGHTS_PUNCTUAL:`KHR_lights_punctual`,KHR_MATERIALS_CLEARCOAT:`KHR_materials_clearcoat`,KHR_MATERIALS_DISPERSION:`KHR_materials_dispersion`,KHR_MATERIALS_IOR:`KHR_materials_ior`,KHR_MATERIALS_SHEEN:`KHR_materials_sheen`,KHR_MATERIALS_SPECULAR:`KHR_materials_specular`,KHR_MATERIALS_TRANSMISSION:`KHR_materials_transmission`,KHR_MATERIALS_IRIDESCENCE:`KHR_materials_iridescence`,KHR_MATERIALS_ANISOTROPY:`KHR_materials_anisotropy`,KHR_MATERIALS_UNLIT:`KHR_materials_unlit`,KHR_MATERIALS_VOLUME:`KHR_materials_volume`,KHR_TEXTURE_BASISU:`KHR_texture_basisu`,KHR_TEXTURE_TRANSFORM:`KHR_texture_transform`,KHR_MESH_QUANTIZATION:`KHR_mesh_quantization`,KHR_MATERIALS_EMISSIVE_STRENGTH:`KHR_materials_emissive_strength`,EXT_MATERIALS_BUMP:`EXT_materials_bump`,EXT_TEXTURE_WEBP:`EXT_texture_webp`,EXT_TEXTURE_AVIF:`EXT_texture_avif`,EXT_MESHOPT_COMPRESSION:`EXT_meshopt_compression`,KHR_MESHOPT_COMPRESSION:`KHR_meshopt_compression`,EXT_MESH_GPU_INSTANCING:`EXT_mesh_gpu_instancing`},zd=class{constructor(e){this.parser=e,this.name=$.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){let e=this.parser,t=this.parser.json.nodes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){let t=this.parser,n=`light:`+e,r=t.cache.get(n);if(r)return r;let i=t.json,a=((i.extensions&&i.extensions[this.name]||{}).lights||[])[e],o,s=new X(16777215);a.color!==void 0&&s.setRGB(a.color[0],a.color[1],a.color[2],Ve);let c=a.range===void 0?0:a.range;switch(a.type){case`directional`:o=new xo(s),o.target.position.set(0,0,-1),o.add(o.target);break;case`point`:o=new vo(s),o.distance=c;break;case`spot`:o=new go(s),o.distance=c,a.spot=a.spot||{},a.spot.innerConeAngle=a.spot.innerConeAngle===void 0?0:a.spot.innerConeAngle,a.spot.outerConeAngle=a.spot.outerConeAngle===void 0?Math.PI/4:a.spot.outerConeAngle,o.angle=a.spot.outerConeAngle,o.penumbra=1-a.spot.innerConeAngle/a.spot.outerConeAngle,o.target.position.set(0,0,-1),o.add(o.target);break;default:throw Error(`THREE.GLTFLoader: Unexpected light type: `+a.type)}return o.position.set(0,0,0),Tf(o,a),a.intensity!==void 0&&(o.intensity=a.intensity),o.name=t.createUniqueName(a.name||`light_`+e),r=Promise.resolve(o),t.cache.add(n,r),r}getDependency(e,t){if(e===`light`)return this._loadLight(t)}createNodeAttachment(e){let t=this,n=this.parser,r=n.json.nodes[e],i=(r.extensions&&r.extensions[this.name]||{}).light;return i===void 0?null:this._loadLight(i).then(function(e){return n._getNodeRef(t.cache,i,e)})}},Bd=class{constructor(){this.name=$.KHR_MATERIALS_UNLIT}getMaterialType(){return Hr}extendParams(e,t,n){let r=[];e.color=new X(1,1,1),e.opacity=1;let i=t.pbrMetallicRoughness;if(i){if(Array.isArray(i.baseColorFactor)){let t=i.baseColorFactor;e.color.setRGB(t[0],t[1],t[2],Ve),e.opacity=t[3]}i.baseColorTexture!==void 0&&r.push(n.assignTexture(e,`map`,i.baseColorTexture,Be))}return Promise.all(r)}},Vd=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){let n=Rd(this.parser,e,this.name);return n===null||n.emissiveStrength!==void 0&&(t.emissiveIntensity=n.emissiveStrength),Promise.resolve()}},Hd=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){return Rd(this.parser,e,this.name)===null?null:ga}extendMaterialParams(e,t){let n=Rd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(n.clearcoatFactor!==void 0&&(t.clearcoat=n.clearcoatFactor),n.clearcoatTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatMap`,n.clearcoatTexture)),n.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=n.clearcoatRoughnessFactor),n.clearcoatRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatRoughnessMap`,n.clearcoatRoughnessTexture)),n.clearcoatNormalTexture!==void 0&&(r.push(this.parser.assignTexture(t,`clearcoatNormalMap`,n.clearcoatNormalTexture)),n.clearcoatNormalTexture.scale!==void 0)){let e=n.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new G(e,e)}return Promise.all(r)}},Ud=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_DISPERSION}getMaterialType(e){return Rd(this.parser,e,this.name)===null?null:ga}extendMaterialParams(e,t){let n=Rd(this.parser,e,this.name);return n===null||(t.dispersion=n.dispersion===void 0?0:n.dispersion),Promise.resolve()}},Wd=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){return Rd(this.parser,e,this.name)===null?null:ga}extendMaterialParams(e,t){let n=Rd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.iridescenceFactor!==void 0&&(t.iridescence=n.iridescenceFactor),n.iridescenceTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceMap`,n.iridescenceTexture)),n.iridescenceIor!==void 0&&(t.iridescenceIOR=n.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),n.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=n.iridescenceThicknessMinimum),n.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=n.iridescenceThicknessMaximum),n.iridescenceThicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceThicknessMap`,n.iridescenceThicknessTexture)),Promise.all(r)}},Gd=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_SHEEN}getMaterialType(e){return Rd(this.parser,e,this.name)===null?null:ga}extendMaterialParams(e,t){let n=Rd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(t.sheenColor=new X(0,0,0),t.sheenRoughness=0,t.sheen=1,n.sheenColorFactor!==void 0){let e=n.sheenColorFactor;t.sheenColor.setRGB(e[0],e[1],e[2],Ve)}return n.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=n.sheenRoughnessFactor),n.sheenColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenColorMap`,n.sheenColorTexture,Be)),n.sheenRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenRoughnessMap`,n.sheenRoughnessTexture)),Promise.all(r)}},Kd=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){return Rd(this.parser,e,this.name)===null?null:ga}extendMaterialParams(e,t){let n=Rd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.transmissionFactor!==void 0&&(t.transmission=n.transmissionFactor),n.transmissionTexture!==void 0&&r.push(this.parser.assignTexture(t,`transmissionMap`,n.transmissionTexture)),Promise.all(r)}},qd=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_VOLUME}getMaterialType(e){return Rd(this.parser,e,this.name)===null?null:ga}extendMaterialParams(e,t){let n=Rd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.thickness=n.thicknessFactor===void 0?0:n.thicknessFactor,n.thicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`thicknessMap`,n.thicknessTexture)),t.attenuationDistance=n.attenuationDistance||1/0;let i=n.attenuationColor||[1,1,1];return t.attenuationColor=new X().setRGB(i[0],i[1],i[2],Ve),Promise.all(r)}},Jd=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_IOR}getMaterialType(e){return Rd(this.parser,e,this.name)===null?null:ga}extendMaterialParams(e,t){let n=Rd(this.parser,e,this.name);return n===null?Promise.resolve():(t.ior=n.ior===void 0?1.5:n.ior,t.ior===0&&(t.ior=1e3),Promise.resolve())}},Yd=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_SPECULAR}getMaterialType(e){return Rd(this.parser,e,this.name)===null?null:ga}extendMaterialParams(e,t){let n=Rd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.specularIntensity=n.specularFactor===void 0?1:n.specularFactor,n.specularTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularIntensityMap`,n.specularTexture));let i=n.specularColorFactor||[1,1,1];return t.specularColor=new X().setRGB(i[0],i[1],i[2],Ve),n.specularColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularColorMap`,n.specularColorTexture,Be)),Promise.all(r)}},Xd=class{constructor(e){this.parser=e,this.name=$.EXT_MATERIALS_BUMP}getMaterialType(e){return Rd(this.parser,e,this.name)===null?null:ga}extendMaterialParams(e,t){let n=Rd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return t.bumpScale=n.bumpFactor===void 0?1:n.bumpFactor,n.bumpTexture!==void 0&&r.push(this.parser.assignTexture(t,`bumpMap`,n.bumpTexture)),Promise.all(r)}},Zd=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){return Rd(this.parser,e,this.name)===null?null:ga}extendMaterialParams(e,t){let n=Rd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.anisotropyStrength!==void 0&&(t.anisotropy=n.anisotropyStrength),n.anisotropyRotation!==void 0&&(t.anisotropyRotation=n.anisotropyRotation),n.anisotropyTexture!==void 0&&r.push(this.parser.assignTexture(t,`anisotropyMap`,n.anisotropyTexture)),Promise.all(r)}},Qd=class{constructor(e){this.parser=e,this.name=$.KHR_TEXTURE_BASISU}loadTexture(e){let t=this.parser,n=t.json,r=n.textures[e];if(!r.extensions||!r.extensions[this.name])return null;let i=r.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures`);return null}return t.loadTextureImage(e,i.source,a)}},$d=class{constructor(e){this.parser=e,this.name=$.EXT_TEXTURE_WEBP}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},ef=class{constructor(e){this.parser=e,this.name=$.EXT_TEXTURE_AVIF}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},tf=class{constructor(e,t){this.name=t,this.parser=e}loadBufferView(e){let t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){let e=n.extensions[this.name],r=this.parser.getDependency(`buffer`,e.buffer),i=this.parser.options.meshoptDecoder;if(!i||!i.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files`);return null}return r.then(function(t){let n=e.byteOffset||0,r=e.byteLength||0,a=e.count,o=e.byteStride,s=new Uint8Array(t,n,r);return i.decodeGltfBufferAsync?i.decodeGltfBufferAsync(a,o,s,e.mode,e.filter).then(function(e){return e.buffer}):i.ready.then(function(){let t=new ArrayBuffer(a*o);return i.decodeGltfBuffer(new Uint8Array(t),a,o,s,e.mode,e.filter),t})})}return null}},nf=class{constructor(e){this.name=$.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){let t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;let r=t.meshes[n.mesh];for(let e of r.primitives)if(e.mode!==mf.TRIANGLES&&e.mode!==mf.TRIANGLE_STRIP&&e.mode!==mf.TRIANGLE_FAN&&e.mode!==void 0)return null;let i=n.extensions[this.name].attributes,a=[],o={};for(let e in i)a.push(this.parser.getDependency(`accessor`,i[e]).then(t=>(o[e]=t,o[e])));return a.length<1?null:(a.push(this.parser.createNodeMesh(e)),Promise.all(a).then(e=>{let t=e.pop(),n=t.isGroup?t.children:[t],r=e[0].count,i=[];for(let e of n){let t=new Y,n=new K,a=new kt,s=new K(1,1,1),c=new Ei(e.geometry,e.material,r);for(let e=0;e<r;e++)o.TRANSLATION&&n.fromBufferAttribute(o.TRANSLATION,e),o.ROTATION&&a.fromBufferAttribute(o.ROTATION,e),o.SCALE&&s.fromBufferAttribute(o.SCALE,e),c.setMatrixAt(e,t.compose(n,a,s));let l=null;for(let e in o)if(e===`_COLOR_0`){let t=o[e];c.instanceColor=new vi(t.array,t.itemSize,t.normalized)}else if(e!==`TRANSLATION`&&e!==`ROTATION`&&e!==`SCALE`){if(l===null){let e=c.geometry;l=new Dr,l.name=e.name;for(let t in e.attributes)l.setAttribute(t,e.attributes[t]);for(let t in e.morphAttributes)l.morphAttributes[t]=e.morphAttributes[t];e.index!==null&&l.setIndex(e.index),l.morphTargetsRelative=e.morphTargetsRelative;for(let t of e.groups)l.addGroup(t.start,t.count,t.materialIndex);e.boundingBox!==null&&(l.boundingBox=e.boundingBox.clone()),e.boundingSphere!==null&&(l.boundingSphere=e.boundingSphere.clone()),l.drawRange.start=e.drawRange.start,l.drawRange.count=e.drawRange.count,l.userData=Object.assign({},e.userData),c.geometry=l}let t=o[e];l.setAttribute(e,new vi(t.array,t.itemSize,t.normalized))}wn.prototype.copy.call(c,e),this.parser.assignFinalMaterial(c),i.push(c)}return t.isGroup?(t.clear(),t.add(...i),t):i[0]}))}},rf=`glTF`,af=12,of={JSON:1313821514,BIN:5130562},sf=class{constructor(e){this.name=$.KHR_BINARY_GLTF,this.content=null,this.body=null;let t=new DataView(e,0,af),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==rf)throw Error(`THREE.GLTFLoader: Unsupported glTF-Binary header.`);if(this.header.version<2)throw Error(`THREE.GLTFLoader: Legacy binary file detected.`);let r=this.header.length-af,i=new DataView(e,af),a=0;for(;a<r;){let t=i.getUint32(a,!0);a+=4;let r=i.getUint32(a,!0);if(a+=4,r===of.JSON){let r=new Uint8Array(e,af+a,t);this.content=n.decode(r)}else if(r===of.BIN){let n=af+a;this.body=e.slice(n,n+t)}a+=t}if(this.content===null)throw Error(`THREE.GLTFLoader: JSON content not found.`)}},cf=class{constructor(e,t){if(!t)throw Error(`THREE.GLTFLoader: No DRACOLoader instance provided.`);this.name=$.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){let n=this.json,r=this.dracoLoader,i=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,o={},s={},c={};for(let e in a){let t=yf[e]||e.toLowerCase();o[t]=a[e]}for(let t in e.attributes){let r=yf[t]||t.toLowerCase();if(a[t]!==void 0){let i=n.accessors[e.attributes[t]];c[r]=hf[i.componentType].name,s[r]=i.normalized===!0}}return t.getDependency(`bufferView`,i).then(function(e){return new Promise(function(t,n){r.decodeDracoFile(e,function(e){for(let t in e.attributes){let n=e.attributes[t],r=s[t];r!==void 0&&(n.normalized=r)}t(e)},o,c,Ve,n)})})}},lf=class{constructor(){this.name=$.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){if((t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0)return e;if(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),t.rotation!==void 0){let t=Math.cos(e.rotation),n=Math.sin(e.rotation);e.matrix.set(e.repeat.x*t,e.repeat.y*n,e.offset.x,-e.repeat.x*n,e.repeat.y*t,e.offset.y,0,0,1),e.matrixAutoUpdate=!1}return e.needsUpdate=!0,e}},uf=class{constructor(){this.name=$.KHR_MESH_QUANTIZATION}},df=class extends wa{constructor(e,t,n,r){super(e,t,n,r)}copySampleValue_(e){let t=this.resultBuffer,n=this.sampleValues,r=this.valueSize,i=e*r*3+r;for(let e=0;e!==r;e++)t[e]=n[i+e];return t}interpolate_(e,t,n,r){let i=this.resultBuffer,a=this.sampleValues,o=this.valueSize,s=o*2,c=o*3,l=r-t,u=(n-t)/l,d=u*u,f=d*u,p=e*c,m=p-c,h=-2*f+3*d,g=f-d,_=1-h,v=g-d+u;for(let e=0;e!==o;e++){let t=a[m+e+o],n=a[m+e+s]*l,r=a[p+e+o],c=a[p+e]*l;i[e]=_*t+v*n+h*r+g*c}return i}},ff=new kt,pf=class extends df{interpolate_(e,t,n,r){let i=super.interpolate_(e,t,n,r);return ff.fromArray(i).normalize().toArray(i),i}},mf={FLOAT:5126,FLOAT_MAT3:35675,FLOAT_MAT4:35676,FLOAT_VEC2:35664,FLOAT_VEC3:35665,FLOAT_VEC4:35666,LINEAR:9729,REPEAT:10497,SAMPLER_2D:35678,POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6,UNSIGNED_BYTE:5121,UNSIGNED_SHORT:5123},hf={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},gf={9728:o,9729:l,9984:s,9985:u,9986:c,9987:d},_f={33071:i,33648:a,10497:r},vf={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},yf={POSITION:`position`,NORMAL:`normal`,TANGENT:`tangent`,TEXCOORD_0:`uv`,TEXCOORD_1:`uv1`,TEXCOORD_2:`uv2`,TEXCOORD_3:`uv3`,COLOR_0:`color`,WEIGHTS_0:`skinWeight`,JOINTS_0:`skinIndex`},bf={scale:`scale`,translation:`position`,rotation:`quaternion`,weights:`morphTargetInfluences`},xf={CUBICSPLINE:void 0,LINEAR:Pe,STEP:Ne},Sf={OPAQUE:`OPAQUE`,MASK:`MASK`,BLEND:`BLEND`};function Cf(e){return e.DefaultMaterial===void 0&&(e.DefaultMaterial=new ha({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:0})),e.DefaultMaterial}function wf(e,t,n){for(let r in n.extensions)e[r]===void 0&&(t.userData.gltfExtensions=t.userData.gltfExtensions||{},t.userData.gltfExtensions[r]=n.extensions[r])}function Tf(e,t){t.extras!==void 0&&(typeof t.extras==`object`?Object.assign(e.userData,t.extras):console.warn(`THREE.GLTFLoader: Ignoring primitive type .extras, `+t.extras))}function Ef(e,t,n){let r=!1,i=!1,a=!1;for(let e=0,n=t.length;e<n;e++){let n=t[e];if(n.POSITION!==void 0&&(r=!0),n.NORMAL!==void 0&&(i=!0),n.COLOR_0!==void 0&&(a=!0),r&&i&&a)break}if(!r&&!i&&!a)return Promise.resolve(e);let o=[],s=[],c=[];for(let l=0,u=t.length;l<u;l++){let u=t[l];if(r){let t=u.POSITION===void 0?e.attributes.position:n.getDependency(`accessor`,u.POSITION);o.push(t)}if(i){let t=u.NORMAL===void 0?e.attributes.normal:n.getDependency(`accessor`,u.NORMAL);s.push(t)}if(a){let t=u.COLOR_0===void 0?e.attributes.color:n.getDependency(`accessor`,u.COLOR_0);c.push(t)}}return Promise.all([Promise.all(o),Promise.all(s),Promise.all(c)]).then(function(t){let n=t[0],o=t[1],s=t[2];return r&&(e.morphAttributes.position=n),i&&(e.morphAttributes.normal=o),a&&(e.morphAttributes.color=s),e.morphTargetsRelative=!0,e})}function Df(e,t){if(e.updateMorphTargets(),t.weights!==void 0)for(let n=0,r=t.weights.length;n<r;n++)e.morphTargetInfluences[n]=t.weights[n];if(t.extras&&Array.isArray(t.extras.targetNames)){let n=t.extras.targetNames;if(e.morphTargetInfluences.length===n.length){e.morphTargetDictionary={};for(let t=0,r=n.length;t<r;t++)e.morphTargetDictionary[n[t]]=t}else console.warn(`THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.`)}}function Of(e){let t,n=e.extensions&&e.extensions[$.KHR_DRACO_MESH_COMPRESSION];if(t=n?`draco:`+n.bufferView+`:`+n.indices+`:`+kf(n.attributes):e.indices+`:`+kf(e.attributes)+`:`+e.mode,e.targets!==void 0)for(let n=0,r=e.targets.length;n<r;n++)t+=`:`+kf(e.targets[n]);return t}function kf(e){let t=``,n=Object.keys(e).sort();for(let r=0,i=n.length;r<i;r++)t+=n[r]+`:`+e[n[r]]+`;`;return t}function Af(e){switch(e){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw Error(`THREE.GLTFLoader: Unsupported normalized accessor component type.`)}}function jf(e){return e.search(/\.jpe?g($|\?)/i)>0||e.search(/^data\:image\/jpeg/)===0?`image/jpeg`:e.search(/\.webp($|\?)/i)>0||e.search(/^data\:image\/webp/)===0?`image/webp`:e.search(/\.ktx2($|\?)/i)>0||e.search(/^data\:image\/ktx2/)===0?`image/ktx2`:`image/png`}var Mf=new Y,Nf=class{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new Ld,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,r=-1,i=!1,a=-1;if(typeof navigator<`u`&&navigator.userAgent!==void 0){let e=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(e)===!0;let t=e.match(/Version\/(\d+)/);r=n&&t?parseInt(t[1],10):-1,i=e.indexOf(`Firefox`)>-1,a=i?e.match(/Firefox\/([0-9]+)\./)[1]:-1}this.textureLoader=typeof createImageBitmap>`u`||n&&r<17||i&&a<98?new eo(this.options.manager):new wo(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new Za(this.options.manager),this.fileLoader.setResponseType(`arraybuffer`),this.options.crossOrigin===`use-credentials`&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){let n=this,r=this.json,i=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(e){return e._markDefs&&e._markDefs()}),Promise.all(this._invokeAll(function(e){return e.beforeRoot&&e.beforeRoot()})).then(function(){return Promise.all([n.getDependencies(`scene`),n.getDependencies(`animation`),n.getDependencies(`camera`)])}).then(function(t){let a={scene:t[0][r.scene||0],scenes:t[0],animations:t[1],cameras:t[2],asset:r.asset,parser:n,userData:{}};return wf(i,a,r),Tf(a,r),Promise.all(n._invokeAll(function(e){return e.afterRoot&&e.afterRoot(a)})).then(function(){for(let e of a.scenes)e.updateMatrixWorld();e(a)})}).catch(t)}_markDefs(){let e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n].joints;for(let t=0,n=r.length;t<n;t++)e[r[t]].isBone=!0}for(let t=0,r=e.length;t<r;t++){let r=e[t];r.mesh!==void 0&&(this._addNodeRef(this.meshCache,r.mesh),r.skin!==void 0&&(n[r.mesh].isSkinnedMesh=!0)),r.camera!==void 0&&this._addNodeRef(this.cameraCache,r.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;let r=n.clone(),i=(e,t)=>{let n=this.associations.get(e);n!=null&&this.associations.set(t,n);for(let[n,r]of e.children.entries())i(r,t.children[n])};return i(n,r),r.name+=`_instance_`+e.uses[t]++,r}_invokeOne(e){let t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){let r=e(t[n]);if(r)return r}return null}_invokeAll(e){let t=Object.values(this.plugins);t.unshift(this);let n=[];for(let r=0;r<t.length;r++){let i=e(t[r]);i&&n.push(i)}return n}getDependency(e,t){let n=e+`:`+t,r=this.cache.get(n);if(!r){switch(e){case`scene`:r=this.loadScene(t);break;case`node`:r=this._invokeOne(function(e){return e.loadNode&&e.loadNode(t)});break;case`mesh`:r=this._invokeOne(function(e){return e.loadMesh&&e.loadMesh(t)});break;case`accessor`:r=this.loadAccessor(t);break;case`bufferView`:r=this._invokeOne(function(e){return e.loadBufferView&&e.loadBufferView(t)});break;case`buffer`:r=this.loadBuffer(t);break;case`material`:r=this._invokeOne(function(e){return e.loadMaterial&&e.loadMaterial(t)});break;case`texture`:r=this._invokeOne(function(e){return e.loadTexture&&e.loadTexture(t)});break;case`skin`:r=this.loadSkin(t);break;case`animation`:r=this._invokeOne(function(e){return e.loadAnimation&&e.loadAnimation(t)});break;case`camera`:r=this.loadCamera(t);break;default:if(r=this._invokeOne(function(n){return n!=this&&n.getDependency&&n.getDependency(e,t)}),!r)throw Error(`Unknown type: `+e)}this.cache.add(n,r)}return r}getDependencies(e){let t=this.cache.get(e);if(!t){let n=this,r=this.json[e+(e===`mesh`?`es`:`s`)]||[];t=Promise.all(r.map(function(t,r){return n.getDependency(e,r)})),this.cache.add(e,t)}return t}loadBuffer(e){let t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!==`arraybuffer`)throw Error(`THREE.GLTFLoader: `+t.type+` buffer type is not supported.`);if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[$.KHR_BINARY_GLTF].body);let r=this.options;return new Promise(function(e,i){n.load(So.resolveURL(t.uri,r.path),e,void 0,function(){i(Error(`THREE.GLTFLoader: Failed to load buffer "`+t.uri+`".`))})})}loadBufferView(e){let t=this.json.bufferViews[e];return this.getDependency(`buffer`,t.buffer).then(function(e){let n=t.byteLength||0,r=t.byteOffset||0;return e.slice(r,r+n)})}loadAccessor(e){let t=this,n=this.json,r=this.json.accessors[e];if(r.bufferView===void 0&&r.sparse===void 0){let e=vf[r.type],t=hf[r.componentType],n=r.normalized===!0,i=new t(r.count*e);return Promise.resolve(new fr(i,e,n))}let i=[];return r.bufferView===void 0?i.push(null):i.push(this.getDependency(`bufferView`,r.bufferView)),r.sparse!==void 0&&(i.push(this.getDependency(`bufferView`,r.sparse.indices.bufferView)),i.push(this.getDependency(`bufferView`,r.sparse.values.bufferView))),Promise.all(i).then(function(e){let i=e[0],a=vf[r.type],o=hf[r.componentType],s=o.BYTES_PER_ELEMENT,c=s*a,l=r.byteOffset||0,u=r.bufferView===void 0?void 0:n.bufferViews[r.bufferView].byteStride,d=r.normalized===!0,f,p;if(u&&u!==c){let e=Math.floor(l/u),n=`InterleavedBuffer:`+r.bufferView+`:`+r.componentType+`:`+e+`:`+r.count,c=t.cache.get(n);c||(f=new o(i,e*u,r.count*u/s),c=new Or(f,u/s),t.cache.add(n,c)),p=new Ar(c,a,l%u/s,d)}else f=i===null?new o(r.count*a):new o(i,l,r.count*a),p=new fr(f,a,d);if(r.sparse!==void 0){let t=vf.SCALAR,n=hf[r.sparse.indices.componentType],s=r.sparse.indices.byteOffset||0,c=r.sparse.values.byteOffset||0,l=new n(e[1],s,r.sparse.count*t),u=new o(e[2],c,r.sparse.count*a);i!==null&&(p=new fr(p.array.slice(),p.itemSize,p.normalized)),p.normalized=!1;for(let e=0,t=l.length;e<t;e++){let t=l[e];if(p.setX(t,u[e*a]),a>=2&&p.setY(t,u[e*a+1]),a>=3&&p.setZ(t,u[e*a+2]),a>=4&&p.setW(t,u[e*a+3]),a>=5)throw Error(`THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.`)}p.normalized=d}return p})}loadTexture(e){let t=this.json,n=this.options,r=t.textures[e].source,i=t.images[r],a=this.textureLoader;if(i.uri){let e=n.manager.getHandler(i.uri);e!==null&&(a=e)}return this.loadTextureImage(e,r,a)}loadTextureImage(e,t,n){let r=this,i=this.json,a=i.textures[e],o=i.images[t],s=(o.uri||o.bufferView)+`:`+a.sampler;if(this.textureCache[s])return this.textureCache[s];let c=this.loadImageSource(t,n).then(function(t){t.flipY=!1,t.name=a.name||o.name||``,t.name===``&&typeof o.uri==`string`&&o.uri.startsWith(`data:image/`)===!1&&(t.name=o.uri);let n=(i.samplers||{})[a.sampler]||{};return t.magFilter=gf[n.magFilter]||1006,t.minFilter=gf[n.minFilter]||1008,t.wrapS=_f[n.wrapS]||1e3,t.wrapT=_f[n.wrapT]||1e3,t.generateMipmaps=!t.isCompressedTexture&&t.minFilter!==1003&&t.minFilter!==1006,r.associations.set(t,{textures:e}),t}).catch(function(){return null});return this.textureCache[s]=c,c}loadImageSource(e,t){let n=this,r=this.json,i=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(e=>e.clone());let a=r.images[e],o=self.URL||self.webkitURL,s=a.uri||``,c=!1;if(a.bufferView!==void 0)s=n.getDependency(`bufferView`,a.bufferView).then(function(e){c=!0;let t=new Blob([e],{type:a.mimeType});return s=o.createObjectURL(t),s});else if(a.uri===void 0)throw Error(`THREE.GLTFLoader: Image `+e+` is missing URI and bufferView`);let l=Promise.resolve(s).then(function(e){return new Promise(function(n,r){let a=n;t.isImageBitmapLoader===!0&&(a=function(e){let t=new Gt(e);t.needsUpdate=!0,n(t)}),t.load(So.resolveURL(e,i.path),a,void 0,r)})}).then(function(e){return c===!0&&o.revokeObjectURL(s),Tf(e,a),e.userData.mimeType=a.mimeType||jf(a.uri),e}).catch(function(e){throw console.error(`THREE.GLTFLoader: Couldn't load texture`,s),e});return this.sourceCache[e]=l,l}assignTexture(e,t,n,r){let i=this;return this.getDependency(`texture`,n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),i.extensions[$.KHR_TEXTURE_TRANSFORM]){let e=n.extensions===void 0?void 0:n.extensions[$.KHR_TEXTURE_TRANSFORM];if(e){let t=i.associations.get(a);a=i.extensions[$.KHR_TEXTURE_TRANSFORM].extendTexture(a,e),i.associations.set(a,t)}}return r!==void 0&&(a.colorSpace=r),e[t]=a,a})}assignFinalMaterial(e){let t=e.geometry,n=e.material,r=t.attributes.tangent===void 0,i=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){let e=`PointsMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new Gi,Ir.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,t.sizeAttenuation=!1,this.cache.add(e,t)),n=t}else if(e.isLine){let e=`LineBasicMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new ji,Ir.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,this.cache.add(e,t)),n=t}if(r||i||a){let e=`ClonedMaterial:`+n.uuid+`:`;r&&(e+=`derivative-tangents:`),i&&(e+=`vertex-colors:`),a&&(e+=`flat-shading:`);let t=this.cache.get(e);t||(t=n.clone(),i&&(t.vertexColors=!0),a&&(t.flatShading=!0),r&&(t.normalScale&&(t.normalScale.y*=-1),t.clearcoatNormalScale&&(t.clearcoatNormalScale.y*=-1)),this.cache.add(e,t),this.associations.set(t,this.associations.get(n))),n=t}e.material=n}getMaterialType(){return ha}loadMaterial(e){let t=this,n=this.json,r=this.extensions,i=n.materials[e],a,o={},s=i.extensions||{},c=[];if(s[$.KHR_MATERIALS_UNLIT]){let e=r[$.KHR_MATERIALS_UNLIT];a=e.getMaterialType(),c.push(e.extendParams(o,i,t))}else{let n=i.pbrMetallicRoughness||{};if(o.color=new X(1,1,1),o.opacity=1,Array.isArray(n.baseColorFactor)){let e=n.baseColorFactor;o.color.setRGB(e[0],e[1],e[2],Ve),o.opacity=e[3]}n.baseColorTexture!==void 0&&c.push(t.assignTexture(o,`map`,n.baseColorTexture,Be)),o.metalness=n.metallicFactor===void 0?1:n.metallicFactor,o.roughness=n.roughnessFactor===void 0?1:n.roughnessFactor,n.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(o,`metalnessMap`,n.metallicRoughnessTexture)),c.push(t.assignTexture(o,`roughnessMap`,n.metallicRoughnessTexture))),a=this._invokeOne(function(t){return t.getMaterialType&&t.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(t){return t.extendMaterialParams&&t.extendMaterialParams(e,o)})))}i.doubleSided===!0&&(o.side=2);let l=i.alphaMode||Sf.OPAQUE;if(l===Sf.BLEND?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,l===Sf.MASK&&(o.alphaTest=i.alphaCutoff===void 0?.5:i.alphaCutoff)),i.normalTexture!==void 0&&a!==Hr&&(c.push(t.assignTexture(o,`normalMap`,i.normalTexture)),o.normalScale=new G(1,1),i.normalTexture.scale!==void 0)){let e=i.normalTexture.scale;o.normalScale.set(e,e)}if(i.occlusionTexture!==void 0&&a!==Hr&&(c.push(t.assignTexture(o,`aoMap`,i.occlusionTexture)),i.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=i.occlusionTexture.strength)),i.emissiveFactor!==void 0&&a!==Hr){let e=i.emissiveFactor;o.emissive=new X().setRGB(e[0],e[1],e[2],Ve)}return i.emissiveTexture!==void 0&&a!==Hr&&c.push(t.assignTexture(o,`emissiveMap`,i.emissiveTexture,Be)),Promise.all(c).then(function(){let n=new a(o);return i.name&&(n.name=i.name),Tf(n,i),t.associations.set(n,{materials:e}),i.extensions&&wf(r,n,i),n})}createUniqueName(e){let t=Ho.sanitizeNodeName(e||``);return t in this.nodeNamesUsed?t+`_`+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){let t=this,n=this.extensions,r=this.primitiveCache;function i(e){return n[$.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(e,t).then(function(n){return Ff(n,e,t)})}let a=[];for(let n=0,o=e.length;n<o;n++){let o=e[n],s=Of(o),c=r[s];if(c)a.push(c.promise);else{let e;e=o.extensions&&o.extensions[$.KHR_DRACO_MESH_COMPRESSION]?i(o):Ff(new Dr,o,t),o.mode===mf.TRIANGLE_STRIP?e=e.then(e=>Nd(e,1)):o.mode===mf.TRIANGLE_FAN&&(e=e.then(e=>Nd(e,2))),r[s]={primitive:o,promise:e},a.push(e)}}return Promise.all(a)}loadMesh(e){let t=this,n=this.json,r=this.extensions,i=n.meshes[e],a=i.primitives,o=[];for(let e=0,t=a.length;e<t;e++){let t=a[e].material===void 0?Cf(this.cache):this.getDependency(`material`,a[e].material);o.push(t)}return o.push(t.loadGeometries(a)),Promise.all(o).then(async function(n){let o=n.slice(0,n.length-1),s=n[n.length-1],c=[];for(let n=0,l=s.length;n<l;n++){let l=s[n],u=a[n],d,f=o[n];if(u.mode===mf.TRIANGLES||u.mode===mf.TRIANGLE_STRIP||u.mode===mf.TRIANGLE_FAN||u.mode===void 0){let e=i.isSkinnedMesh===!0,t=l.hasAttribute(`skinIndex`)&&l.hasAttribute(`skinWeight`);e&&t===!1&&console.warn(`THREE.GLTFLoader: Missing skinIndex or skinWeight attributes. Skinning disabled.`),d=e&&t?new fi(l,f):new ei(l,f),d.isSkinnedMesh===!0&&d.normalizeSkinWeights()}else if(u.mode===mf.LINES)d=new Ui(l,f);else if(u.mode===mf.LINE_STRIP)d=new zi(l,f);else if(u.mode===mf.LINE_LOOP)d=new Wi(l,f);else if(u.mode===mf.POINTS)d=new Xi(l,f);else throw Error(`THREE.GLTFLoader: Primitive mode unsupported: `+u.mode);Object.keys(d.geometry.morphAttributes).length>0&&Df(d,i),d.name=t.createUniqueName(i.name||`mesh_`+e),Tf(d,i),u.extensions&&wf(r,d,u),t.assignFinalMaterial(d),c.push(d)}for(let n=0,r=c.length;n<r;n++)t.associations.set(c[n],{meshes:e,primitives:n});if(c.length===1)return i.extensions&&wf(r,c[0],i),c[0];let l=new Tn;i.extensions&&wf(r,l,i),t.associations.set(l,{meshes:e});for(let e=0,t=c.length;e<t;e++)l.add(c[e]);return l})}loadCamera(e){let t,n=this.json.cameras[e],r=n[n.type];if(!r){console.warn(`THREE.GLTFLoader: Missing camera parameters.`);return}return n.type===`perspective`?t=new mo(Ot.radToDeg(r.yfov),r.aspectRatio||1,r.znear||1,r.zfar||2e6):n.type===`orthographic`&&(t=new yo(-r.xmag,r.xmag,r.ymag,-r.ymag,r.znear,r.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),Tf(t,n),Promise.resolve(t)}loadSkin(e){let t=this.json.skins[e],n=[];for(let e=0,r=t.joints.length;e<r;e++)n.push(this._loadNodeShallow(t.joints[e]));return t.inverseBindMatrices===void 0?n.push(null):n.push(this.getDependency(`accessor`,t.inverseBindMatrices)),Promise.all(n).then(function(e){let n=e.pop(),r=e,i=[],a=[];for(let e=0,o=r.length;e<o;e++){let o=r[e];if(o){i.push(o);let t=new Y;n!==null&&t.fromArray(n.array,e*16),a.push(t)}else console.warn(`THREE.GLTFLoader: Joint "%s" could not be found.`,t.joints[e])}return new _i(i,a)})}loadAnimation(e){let t=this.json,n=this,r=t.animations[e],i=r.name?r.name:`animation_`+e,a=[],o=[],s=[],c=[],l=[];for(let e=0,t=r.channels.length;e<t;e++){let t=r.channels[e],n=r.samplers[t.sampler],i=t.target,u=i.node,d=r.parameters===void 0?n.input:r.parameters[n.input],f=r.parameters===void 0?n.output:r.parameters[n.output];i.node!==void 0&&(a.push(this.getDependency(`node`,u)),o.push(this.getDependency(`accessor`,d)),s.push(this.getDependency(`accessor`,f)),c.push(n),l.push(i))}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(s),Promise.all(c),Promise.all(l)]).then(function(e){let t=e[0],a=e[1],o=e[2],s=e[3],c=e[4],l=[];for(let e=0,r=t.length;e<r;e++){let r=t[e],i=a[e],u=o[e],d=s[e],f=c[e];if(r===void 0)continue;r.updateMatrix&&r.updateMatrix();let p=n._createAnimationTracks(r,i,u,d,f);if(p)for(let e=0;e<p.length;e++)l.push(p[e])}let u=new Va(i,void 0,l);return Tf(u,r),u})}createNodeMesh(e){let t=this.json,n=this,r=t.nodes[e];return r.mesh===void 0?null:n.getDependency(`mesh`,r.mesh).then(function(e){let t=n._getNodeRef(n.meshCache,r.mesh,e);return r.weights!==void 0&&t.traverse(function(e){if(e.isMesh)for(let t=0,n=r.weights.length;t<n;t++)e.morphTargetInfluences[t]=r.weights[t]}),t})}loadNode(e){let t=this.json,n=this,r=t.nodes[e],i=n._loadNodeShallow(e),a=[],o=r.children||[];for(let e=0,t=o.length;e<t;e++)a.push(n.getDependency(`node`,o[e]));let s=r.skin===void 0?Promise.resolve(null):n.getDependency(`skin`,r.skin);return Promise.all([i,Promise.all(a),s]).then(function(e){let t=e[0],n=e[1],r=e[2];r!==null&&t.traverse(function(e){e.isSkinnedMesh&&e.bind(r,Mf)});for(let e=0,r=n.length;e<r;e++)t.add(n[e]);if(t.userData.pivot!==void 0&&n.length>0){let e=t.userData.pivot,r=n[0];t.pivot=new K().fromArray(e),t.position.x-=e[0],t.position.y-=e[1],t.position.z-=e[2],r.position.set(0,0,0),delete t.userData.pivot}return t})}_loadNodeShallow(e){let t=this.json,n=this.extensions,r=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];let i=t.nodes[e],a=i.name?r.createUniqueName(i.name):``,o=[],s=r._invokeOne(function(t){return t.createNodeMesh&&t.createNodeMesh(e)});return s&&o.push(s),i.camera!==void 0&&o.push(r.getDependency(`camera`,i.camera).then(function(e){return r._getNodeRef(r.cameraCache,i.camera,e)})),r._invokeAll(function(t){return t.createNodeAttachment&&t.createNodeAttachment(e)}).forEach(function(e){o.push(e)}),this.nodeCache[e]=Promise.all(o).then(function(t){let o;if(o=i.isBone===!0?new pi:t.length>1?new Tn:t.length===1?t[0]:new wn,o!==t[0])for(let e=0,n=t.length;e<n;e++)o.add(t[e]);if(i.name&&(o.userData.name=i.name,o.name=a),Tf(o,i),i.extensions&&wf(n,o,i),i.matrix!==void 0){let e=new Y;e.fromArray(i.matrix),o.applyMatrix4(e)}else i.translation!==void 0&&o.position.fromArray(i.translation),i.rotation!==void 0&&o.quaternion.fromArray(i.rotation),i.scale!==void 0&&o.scale.fromArray(i.scale);if(!r.associations.has(o))r.associations.set(o,{});else if(i.mesh!==void 0&&r.meshCache.refs[i.mesh]>1){let e=r.associations.get(o);r.associations.set(o,{...e})}return r.associations.get(o).nodes=e,o}),this.nodeCache[e]}loadScene(e){let t=this.extensions,n=this.json.scenes[e],r=this,i=new Tn;n.name&&(i.name=r.createUniqueName(n.name)),Tf(i,n),n.extensions&&wf(t,i,n);let a=n.nodes||[],o=[];for(let e=0,t=a.length;e<t;e++)o.push(r.getDependency(`node`,a[e]));return Promise.all(o).then(function(e){for(let t=0,n=e.length;t<n;t++){let n=e[t];n.parent===null?i.add(n):i.add(Pd(n))}return r.associations=(e=>{let t=new Map;for(let[e,n]of r.associations)(e instanceof Ir||e instanceof Gt)&&t.set(e,n);return e.traverse(e=>{let n=r.associations.get(e);n!=null&&t.set(e,n)}),t})(i),i})}_createAnimationTracks(e,t,n,r,i){let a=[],o=e.name?e.name:e.uuid,s=[];function c(e){e.morphTargetInfluences&&s.push(e.name?e.name:e.uuid)}bf[i.path]===bf.weights?(c(e),e.isGroup&&e.children.forEach(c)):s.push(o);let l;switch(bf[i.path]){case bf.weights:l=Ia;break;case bf.rotation:l=Ra;break;case bf.translation:case bf.scale:l=Ba;break;default:switch(n.itemSize){case 1:l=Ia;break;default:l=Ba}}let u=r.interpolation===void 0?Pe:xf[r.interpolation],d=this._getArrayFromAccessor(n);for(let e=0,n=s.length;e<n;e++){let n=new l(s[e]+`.`+bf[i.path],t.array,d,u);r.interpolation===`CUBICSPLINE`&&this._createCubicSplineTrackInterpolant(n),a.push(n)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){let e=Af(t.constructor),n=new Float32Array(t.length);for(let r=0,i=t.length;r<i;r++)n[r]=t[r]*e;t=n}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(e){return new(this instanceof Ra?pf:df)(this.times,this.values,this.getValueSize()/3,e)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}};function Pf(e,t,n){let r=t.attributes,i=new Jn;if(r.POSITION!==void 0){let e=n.json.accessors[r.POSITION],t=e.min,a=e.max;if(t!==void 0&&a!==void 0){if(i.set(new K(t[0],t[1],t[2]),new K(a[0],a[1],a[2])),e.normalized){let t=Af(hf[e.componentType]);i.min.multiplyScalar(t),i.max.multiplyScalar(t)}}else{console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`);return}}else return;let a=t.targets;if(a!==void 0){let e=new K,t=new K;for(let r=0,i=a.length;r<i;r++){let i=a[r];if(i.POSITION!==void 0){let r=n.json.accessors[i.POSITION],a=r.min,o=r.max;if(a!==void 0&&o!==void 0){if(t.setX(Math.max(Math.abs(a[0]),Math.abs(o[0]))),t.setY(Math.max(Math.abs(a[1]),Math.abs(o[1]))),t.setZ(Math.max(Math.abs(a[2]),Math.abs(o[2]))),r.normalized){let e=Af(hf[r.componentType]);t.multiplyScalar(e)}e.max(t)}else console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`)}}i.expandByVector(e)}e.boundingBox=i;let o=new yr;i.getCenter(o.center),o.radius=i.min.distanceTo(i.max)/2,e.boundingSphere=o}function Ff(e,t,n){let r=t.attributes,i=[];function a(t,r){return n.getDependency(`accessor`,t).then(function(t){e.setAttribute(r,t)})}for(let t in r){let n=yf[t]||t.toLowerCase();n in e.attributes||i.push(a(r[t],n))}if(t.indices!==void 0&&!e.index){let r=n.getDependency(`accessor`,t.indices).then(function(t){e.setIndex(t)});i.push(r)}return J.workingColorSpace!==`srgb-linear`&&`COLOR_0`in r&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${J.workingColorSpace}" not supported.`),Tf(e,t),Pf(e,t,n),Promise.all(i).then(function(){return t.targets===void 0?e:Ef(e,t.targets,n)})}var If=`/3d-room/assets/baked-0.75-Bm0rtzzN.jpg`,Lf=`/3d-room/assets/baked-mac-ba-PN9Gz.jpg`,Rf=`/3d-room/assets/poster-DO9qIPvO.jpg`,zf=`/3d-room/assets/room_corner-D1ytxZ1B.glb`,Bf=`/3d-room/assets/window-view-e8NIh_Up.jpg`,Vf=1.16,Hf=1,Uf=.4,Wf=.3;function Gf(e){let t=new Hr({map:e,side:2}),n={value:new G},r={value:Hf};return t.customProgramCacheKey=()=>`window-parallax`,t.onBeforeCompile=e=>{e.uniforms.uWindowOffset=n,e.uniforms.uWindowScale=r,e.vertexShader=e.vertexShader.replace(`#include <uv_vertex>`,`
        #include <uv_vertex>
        vMapUv = (vMapUv - 0.5) * uWindowScale + 0.5 + uWindowOffset;
      `),e.vertexShader=`uniform vec2 uWindowOffset;\nuniform float uWindowScale;\n${e.vertexShader}`},{material:t,offset:n,scale:r}}var Kf=class{constructor(e,t){this.object=e,this.offset=t.offset,this.scale=t.scale,this.restPosition=e.position.clone(),this.restScale=e.scale.clone(),e.scale.multiplyScalar(Vf),this.center=new K,this.normal=new K,this.right=new K,this.up=new K,this.viewRight=new K,this.viewUp=new K,this.referenceLateral=new G,this._toCamera=new K,this._worldPoint=new K,this._quat=new kt}setReference(e){this.object.updateWorldMatrix(!0,!1),this.object.getWorldPosition(this.center),this.object.getWorldQuaternion(this._quat),this.object.geometry.computeBoundingBox();let t=this.object.geometry.boundingBox.getSize(new K),n=[new K(1,0,0),new K(0,1,0),new K(0,0,1)],r=[t.x,t.y,t.z],i=r.indexOf(Math.min(r[0],r[1],r[2])),a=(i+1)%3,o=(i+2)%3;this.right.copy(n[a]).applyQuaternion(this._quat).normalize(),this.up.copy(n[o]).applyQuaternion(this._quat).normalize(),this.normal.copy(n[i]).applyQuaternion(this._quat).normalize(),this._toCamera.copy(e).sub(this.center),this.normal.dot(this._toCamera)<0&&this.normal.negate();let s=new K(0,1,0);this.viewRight.crossVectors(s,this.normal),this.viewRight.lengthSq()<1e-8&&this.viewRight.set(1,0,0),this.viewRight.normalize(),this.viewUp.crossVectors(this.normal,this.viewRight).normalize(),this.viewUp.dot(s)<0&&(this.viewUp.negate(),this.viewRight.negate()),this.referenceLateral.set(this._toCamera.dot(this.right),this._toCamera.dot(this.up)),this.scale.value=Hf,this.offset.value.set(0,0)}update(e){this._toCamera.copy(e.position).sub(this.center);let t=(this._toCamera.dot(this.right)-this.referenceLateral.x)*Uf,n=(this._toCamera.dot(this.up)-this.referenceLateral.y)*Uf;this._worldPoint.copy(this.center).addScaledVector(this.right,t).addScaledVector(this.up,n).addScaledVector(this.viewRight,Wf).addScaledVector(this.viewUp,-.27),this.object.parent.worldToLocal(this._worldPoint),this.object.position.copy(this._worldPoint),this.scale.value=Hf}};function qf(e,t){let n=e;for(;n;){if(n.name===t)return!0;n=n.parent}return!1}function Jf(e,t){e.flipY=!1,e.colorSpace=Be,e.anisotropy=8,e.channel=t}function Yf(e){let t=e.image,n=t.naturalWidth||t.width,r=t.naturalHeight||t.height,i=document.createElement(`canvas`);i.width=n,i.height=r;let a=i.getContext(`2d`);a.drawImage(t,0,0,n,r),a.fillStyle=`rgba(255, 255, 255, 0.48)`,a.fillRect(0,0,n,r);let o=new $i(i);return Jf(o,2),o}var Xf=new Set([`LampMetal`,`LampInner`,`LampShade`]);function Zf(e,t){let n=e;for(;n&&n!==t;){let t=Cd[n.name];if(t){e.userData.inspectId=t;return}n=n.parent}}function Qf(e){return Array.isArray(e.material)?e.material[0]?.name:e.material?.name}async function $f(e,t){let n=new Ka;n.onProgress=(e,n,r)=>{t?.(r>0?n/r:0)};let r=new eo(n),i=new jd;i.setDecoderPath(`/3d-room/draco/`),i.preload();let a=new Id(n);a.setDRACOLoader(i);let[o,s,c,l,u]=await Promise.all([r.loadAsync(If),r.loadAsync(Lf),r.loadAsync(Rf),r.loadAsync(Bf),a.loadAsync(zf)]);o.flipY=!1,o.colorSpace=Be,o.anisotropy=8,Jf(s,0),Jf(c,1);let d=new Hr({map:o}),f=new Hr({map:s,side:2}),p=new Hr({map:c,side:2}),m=Gf(Yf(l)),h=m.material,g=u.scene;e.add(g);let _=null,v=null;if(g.traverse(e=>{if(!e.isMesh)return;if(!e.material||e.name.startsWith(`Плоскость`)){e.visible=!1;return}if(Zf(e,g),qf(e,`WindowView`)){e.material=h,v=e;return}if(qf(e,`Poster`)){e.material=p;return}let t=Qf(e);if(t===`Screen`){_=e,e.material=new Hr({color:328965});return}if(qf(e,`Mac`)){e.material=f;return}if(Xf.has(t)){e.material=new Hr({map:o,side:2});return}e.material=d}),!_)throw Error(`Laptop screen mesh not found in room_corner.glb`);return{roomRoot:g,laptopScreen:_,windowView:v,windowUniforms:m}}var ep=class extends wu{async init(){this.threeScene=new Nn,this.threeScene.background=new X(1709844),this.cameraRig=new cd,this.camera=this.cameraRig.camera,this.terminal=new Tu,this.terminal.onSubmit=()=>{this.playNpmFail()},this.terminal.autoFill=window.matchMedia(`(pointer: coarse)`).matches,this.terminal.draw(),this.screenTexture=new $i(this.terminal.canvas),this.screenTexture.colorSpace=Be,this.screenTexture.anisotropy=8,this.screenTexture.flipY=!0,this.crtMaterial=Ou(this.screenTexture),this.crtMaterial.side=0,this.bootStarted=!1,this.bootTime=0,this.power=0,this.cameraBlend=0,this.pullbackStarted=!1,this.pullbackTime=0,this.pullbackBlend=0,this.textStarted=!1,this.storyStarted=!1,this.playMode=`interactive`,this.storyViewEntered=!1,this.hint=document.querySelector(`#start-hint`),this.modeToggle=document.querySelector(`#mode-toggle`),this.displayMesh=null,this.previousToneMapping=this.game.renderer.toneMapping,this.previousExposure=this.game.renderer.toneMappingExposure,this.game.renderer.toneMapping=0,this.game.renderer.toneMappingExposure=1;let{roomRoot:e,laptopScreen:t,windowView:n,windowUniforms:r}=await $f(this.threeScene,bu);this.roomRoot=e,this.laptopScreen=t,this.windowParallax=n?new Kf(n,r):null,this.threeScene.updateMatrixWorld(!0),this.cameraRig.aim(t,e),this.windowParallax?.setReference(this.camera.position),this.displayMesh=Ed({laptopScreen:t,material:this.crtMaterial,screenNormal:this.cameraRig.screenNormal,previous:this.displayMesh}),this.cameraRig.setupControls(this.game.canvas),this.inspect=new Td({threeScene:this.threeScene,camera:this.camera,renderer:this.game.renderer,canvas:this.game.canvas,getPlayMode:()=>this.playMode,cameraRig:this.cameraRig}),this.inspect.setup(e,this.displayMesh),this.bindInput(),this.bindModeToggle(),this.inspect.bind(),this.ready=!0}bindModeToggle(){this.modeToggle&&(this.onModePointer=e=>{e.stopPropagation();let t=e.target.closest(`[data-mode]`);t?.dataset.mode&&this.setPlayMode(t.dataset.mode)},this.modeToggle.addEventListener(`pointerdown`,this.onModePointer))}setPlayMode(e){(e===`view`||e===`interactive`)&&e!==this.playMode&&(this.inspect.closeModal(),this.inspect.setHovered(null),this.playMode=e,this.syncModeToggle(),e===`view`?(this.hideStartHint(),this.cameraRig.enterViewMode({useDefaultPose:this.storyViewEntered})):(this.cameraRig.enterInteractiveMode(this.cameraBlend,this.pullbackBlend),this.showStartHint()))}syncModeToggle(){this.modeToggle&&this.modeToggle.querySelectorAll(`[data-mode]`).forEach(e=>{let t=e.dataset.mode===this.playMode;e.classList.toggle(`is-active`,t),e.setAttribute(`aria-pressed`,t?`true`:`false`)})}bindInput(){this.onPointer=e=>{if(!(this.inspect.open||e.target.closest?.(`#mode-toggle`)||e.target.closest?.(`#inspect-modal`))&&this.playMode!==`view`&&!this.inspect.canInspect(this.inspect.hitId(e))){if(!this.bootStarted){this.beginBoot();return}this.handleTap()}},this.onKey=e=>{if(!this.inspect.onKey(e)&&!(this.inspect.open||this.playMode===`view`)){if(!this.bootStarted){this.beginBoot();return}this.terminal.handleKey(e)}},window.addEventListener(`pointerdown`,this.onPointer),window.addEventListener(`keydown`,this.onKey)}handleTap(){if(this.terminal.inputEnabled){if(this.terminal.isComplete()){this.terminal.submit();return}this.terminal.typeForcedChar()}}hideStartHint(){this.hint&&(this.hint.classList.add(`is-hidden`),this.hint.setAttribute(`aria-hidden`,`true`),window.clearTimeout(this.hintHideTimer),this.hintHideTimer=window.setTimeout(()=>{(this.playMode===`view`||this.bootStarted)&&(this.hint.hidden=!0)},800))}showStartHint(){!this.bootStarted&&this.hint&&(window.clearTimeout(this.hintHideTimer),this.hint.hidden=!1,this.hint.classList.remove(`is-hidden`),this.hint.setAttribute(`aria-hidden`,`false`))}async beginBoot(){this.bootStarted||(this.bootStarted=!0,this.hideStartHint(),await this.game.audio.unlock(),this.game.audio.playBoot())}async playNpmFail(){this.storyStarted||(this.storyStarted=!0,await this.terminal.print(`
'npm' is not recognized as an internal or external command`),await this.wait(1.6),await this.terminal.print(`

You have a lot to learn.`),this.pullbackStarted=!0)}wait(e){return new Promise(t=>{window.setTimeout(t,e*1e3)})}updateCrt(e){this.crtMaterial.uniforms.uTime.value+=e,this.crtMaterial.uniforms.uPower.value=this.power}update(e){if(this.playMode===`view`){this.updateCrt(e),this.cameraRig.updatePose(e)?this.cameraRig.poseActive||this.cameraRig.setControlsEnabled(!0):this.cameraRig.controls?.update(),this.windowParallax?.update(this.camera);return}if(this.cameraRig.poseActive){this.updateCrt(e),this.cameraRig.updatePose(e),this.windowParallax?.update(this.camera);return}this.bootStarted&&(this.bootTime+=e,this.power=ku(this.bootTime/2.15,0,1),this.power>.72&&!this.textStarted&&(this.textStarted=!0,this.terminal.startReveal()),this.cameraBlend=ju(ku((this.bootTime-.9)/3.4,0,1))),this.pullbackStarted&&(this.pullbackTime+=e,this.pullbackBlend=ju(ku(this.pullbackTime/3.3,0,1))),this.terminal.update(e)&&(this.screenTexture.needsUpdate=!0),this.updateCrt(e),this.cameraRig.applyStoryCamera(this.cameraBlend,this.pullbackBlend),!this.storyViewEntered&&this.pullbackStarted&&this.pullbackBlend>=1&&(this.storyViewEntered=!0,this.playMode!==`view`&&this.setPlayMode(`view`)),this.windowParallax?.update(this.camera)}render(){this.inspect.render()||this.game.renderer.render(this.threeScene,this.camera)}resize(e,t){this.cameraRig.resize(e,t,this.playMode,this.cameraBlend,this.pullbackBlend),this.inspect.resize(e,t)}exit(){window.removeEventListener(`pointerdown`,this.onPointer),window.removeEventListener(`keydown`,this.onKey),this.modeToggle?.removeEventListener(`pointerdown`,this.onModePointer),this.inspect.dispose(),this.cameraRig.dispose(),this.game.renderer.toneMapping=this.previousToneMapping,this.game.renderer.toneMappingExposure=this.previousExposure}},tp=new Cu(document.querySelector(`#game`));tp.sceneManager.register(`boot`,new ep(tp)),tp.start(`boot`);